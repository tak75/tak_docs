...
.. csv-table:: HotなIObservableを作成するファクトリメソッド
   ...
   `6 <https://blog.okazuki.jp/entry/20111109/1320849106>`__,:term:`ToAsync`,.. figure:: images/ToAsync.png,バックグラウンドで任意のタイミングで処理を実行し結果を返す,""
   `6 <https://blog.okazuki.jp/entry/20111109/1320849106>`__,:term:`FromAsyncPattern`,.. figure:: images/FromAsyncPattern.png,,""
...
.. csv-table:: フィルタリングメソッド
   ...
   ,:term:`OfType<T>`,.. figure:: images/OfType.png,型が一致するもののみ通す(型変換も同時に行う),""
...
.. csv-table:: Observable自体の変換メソッド
   ...
   ,:term:`ToReadOnlyReactiveProperty`,.. figure:: images/ToReadOnlyReactiveProperty.png,ObservableをReadOnlyReactivePropertyに変換,""
   ,:term:`ToYieldInstruction`,.. figure:: images/ToYieldInstruction.png,コルーチンでObservableを待つ,""
...
.. csv-table:: Observableの分岐メソッド
   ...
   ,:term:`ToReactivePropety`,.. figure:: images/ToReactivePropety.png,Observableを枝分かれさせる,
   ,:term:`Publish`,.. figure:: images/Publish.png,Observableを枝分かれさせつつ、初期値を指定,引数を与えるとMulticast(BehaviorSubject)と同義
   ...
   ,:term:`Multicast`,.. figure:: images/Multicast.png,Observableを枝分かれさせる時にSubjectを指定,
   ,:term:`RefCount`,.. figure:: images/RefCount.png,Observerが1つでもいたらConnectし、いなくなったらDispose,Publish().RefCount()はほぼ定型文
   ,:term:`Share`,.. figure:: images/Share.png,Publish().RefCount()を省略,
...
.. csv-table:: メッセージ同士の合成・演算
   ...
   ,:term:`PairWise`,.. figure:: images/PairWise.png,直前のメッセージとセットにする,"Bufer(2,1)と挙動は似ている"
...
.. csv-table:: メッセージの変換
   ...
   ,:term:`Cast<T>`,.. figure:: images/Cast.png,型変換をする,
   ,:term:`SelectMany`,.. figure:: images/SelectMany.png,メッセージの値を元に別のObservableを呼び出してそちらの結果を利用,Observableを合成
   ...
   ,:term:`AsUnitObservable`,.. figure:: images/AsUnitObservable.png,メッセージをUnit型に変換,Select(_=>Unit.Default)と同義
