...
.. figure:: images/AWS応用1_CloudFront.png
   :width: 640px
   :name: AWS応用1_CloudFront

   本項で構築するAWS環境（CloudFront）
...
.. figure:: images/AWS応用2_Webサーバの冗長化.png
   :width: 640px
   :name: AWS応用2_Webサーバの冗長化

   本項で構築するAWS環境（Webサーバの冗長化）
